...
const Hints = () => {
  return (
    <div>
        <div>
            <div className='hints bg-secondary'>
        <h3 className='h33'> Example:</h3> <br />

<p className='nmop text-danger'>Develop a story from the hints.</p><br />
